...
<head>
  ...
  <title>Register - Ecommerce Solution</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action = "process-register.php" method = "POST" class="row g-3 needs-validation" >
                    <div class="col-12">
...
<!-- 
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="reg-user">Create Account</button>
                    </div>
                    <div class="col-12">
