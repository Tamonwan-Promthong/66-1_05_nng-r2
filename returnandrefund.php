...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/ee2.png" rel="icon">
...
<ul class="d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <h1 style="margin: 0;">การคืนเงิน</h1>
                              <!-- <a href="buying.php">
                ...
                <table class="table ">
                        ...
                        <tbody>
                            ...
                            if(isset($_GET['id'])) {
                                ...
                                // Now you can use $orderId to fetch and display order details from the database
                                // For example:
                                ...
                                if($stmt->rowCount() > 0) {
                                    ...
                                    // No rows found for the provided orderId
    ...
    <div class="row mb-4">
        ...
        if(isset($_GET['id'])) {
            ...
            <div class="col-md-6 mb-3">
                ...
                <div class="form-control"><?php echo $row['nameCustomer']; ?></div>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">เบอร์โทรลูกค้า</label>
                <div class="form-control"><?php echo $row['tel']; ?></div>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">ที่อยู่ลูกค้า</label>
                <div class="form-control"><?php echo $row['addrCustomer']; ?></div>
            </div>
            <?php
        }
        ?>
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">รายละเอียดการคืนเงิน</h5>  
            <form class="row g-3" action="refundOrder.php" method="post" enctype="multipart/form-data"> 
          <!-- <div class="col-md-6"> -->
          <!-- <fieldset class="row mb-3">
        <label for="inputAddress5" class="form-label">การชำระเงิน</label>
        <div class="col-sm-10">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="option1" checked onchange="toggleFields('option1')">
                <label class="form-check-label" for="gridRadios1">
                    คืนเงิน
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios2" value="option2" onchange="toggleFields('option2')">
...
<!-- 
            ...
            <div class="col-md-6">
            <label for="inputState" class="form-label">หลักฐานการคืนเงินให้ลูกค้า</label>
                    <input class="form-control" type="file" id="formFile"name="slipRefund">
            </div> 
            <div class="col-md-6">
                <label for="inputState" class="form-label">ธนาคาร</label>
                <select id="inputState" class="form-select" name="bankId">
                <option selected>Choose...</option>
                    <?php
                    require_once 'dbConfig.php';
            ...
            <div class="col-md-6">
                              <label for="inputAddress5" class="form-label">หมายเลขบัญชี</label>
                              <input type="text" class="form-control" id="inputAddres5s" name = "accountNum" >
            </div>
            <div class="col-md-6">
                <label for="inputState" class="form-label">หมายเหตุ</label>
                <div class="form-floating">
                    <textarea class="form-control"  id="floatingTextarea" style="height: 100px;" name="refundDetail" ></textarea>
          ...
          <div class="col-md-6">
                <label for="inputState" class="form-label">เหตุผลในการเปลี่ยนสินค้า</label>
                <select id="inputState" class="form-select" name="cancleId">
                    <option selected>Choose...</option>
                    <?php
                    require_once 'dbConfig.php';
            ...
            <div class="col-md-6">
                <label for="inputState" class="form-label">รายการที่ต้องการเปลี่ยนสินค้า</label>
                <div class="card-body">
